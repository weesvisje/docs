...
## 2-1 Enable nodeIntegration


When you cloned the quick start project, there should be a file called __main.js__. 

In `main.js`, add the following lines to your browser window: 
...
## 2-2 Add `ditto` to `renderer.js`

When you cloned the quick start project, there should be a file called __renderer.js__. We will need an instance of Ditto throughout this tutorial and the app's lifecycle.
