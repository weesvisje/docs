...
*before* going offline.  Online Playground certificates will expire after **one week**.
That means that any device can be offline for one week. Once the certificate has expired, the device
