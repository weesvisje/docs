...
implement similar behavior by using a Map type.
...
We can convert this from an array to a Map where:
...
This could would result in a document that looks like this:
