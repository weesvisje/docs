...
"title == $args.title", { title: 'Harry Potter' }

// finds documents which that are not of the title Lord of the Rings
"title != $args.title", { title: 'Lord of the Rings' }
```
...
```js
"created_at >= $args.date", { date: "2022-04-29T00:55:31.859Z"}
```

### Booleans

Use when your property is of type Boolean
