...
```js
let liveQuery = ditto.store.collection('cars').find("name == 'Toyota'").observe((cars) => {
      ...
      // highlight-start
        credentialsManager.credentials { error, credentials in
          ...
          // highlight-end
            ...
            // highlight-start
            self.ditto = ditto
            let liveQuery = ditto.store.collection("cars").find("name == 'Toyota'").observe { docs, event in
                self.docs = docs
            }
            // highlight-end
