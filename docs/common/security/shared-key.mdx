...
:::info
Shared key is appropriate for devices that never connect to the Internet. 

If you need to syncronize data over the Internet with the Big Peer, [use Online With Authentication instead](./authentication/overview).
:::
