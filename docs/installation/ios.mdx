...
1. Open your Xcode project, select "File" > "Add Packages...". Enter the following
   package URL in search box in the upper right corner: https://github.com/getditto/DittoSwift
