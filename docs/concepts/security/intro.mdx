...
* [Online Playground](/concepts/security/online-playground) - great for prototyping with Ditto. Beginners should start here!
* [Online With Authentication](/concepts/security/online-with-authentication/overview) - for apps that you'll deploy with authentication and customized permissioning

There are other identities geared towards peer-to-peer only scenarios. [You can read more about them here.](/advanced/identities)