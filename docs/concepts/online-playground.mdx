...
:::info
Devices using Online Playground need to connect to the Internet at least once
before syncronizing with other peers. This is required so devices can get a
valid certificate before going offline.  
:::
