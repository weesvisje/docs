...
*before* going offline.  Online Playground certificates will expire after **15 minutes**.
That means that any device can be offline for only 15 minutes until that device
must re-connect to the Internet and refresh their certificate. Use
